...
(async() => {
    ...
    try {
    await page.setViewport({width: 1920, height: 1080, isMobile: false, isLandscape: true, hasTouch: false, deviceScaleFactor: 1})
    await page.goto('https://youtube.com');

    const acceptSelector = 'button.yt-spec-button-shape-next[aria-label="Acceptér brugen af cookies og andre data til de formål, der er beskrevet"]'
